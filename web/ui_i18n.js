(function () {
  ...
  const PHRASES = {
    ...
    "客户经理 `li.sales / Pass@123`，电商负责人 `wang.manager / Pass@123`，财务总监 `liu.finance / Pass@123`，超级管理员 `sun.admin / Admin@123`。": {
      en: "Customer Manager `li.sales / Pass@123`, E-commerce Lead `wang.manager / Pass@123`, Finance Director `liu.finance / Pass@123`, Super Admin `sun.admin / Admin@123`.",
      de: "Kundenmanager `li.sales / Pass@123`, E-Commerce-Leitung `wang.manager / Pass@123`, Finanzdirektor `liu.finance / Pass@123`, Super-Admin `sun.admin / Admin@123`.",
    },
